	...
	<div class="container">
		...
		<div class="screen">
			<div class="screen__content">
				<form class="login" action="LoginController" method="POST" onsubmit="return formValidation()">
					<div class="login__field">
						<i class="login__icon fas fa-user"></i> <input type="text"
							class="login__input" placeholder="10-digit UTD ID"
							name="student-id" id="student-id" required>
					</div>
					<div class="login__field">
						<i class="login__icon fas fa-lock"></i> <input type="password"
							class="login__input" placeholder="Password" name="password-input"
					...
					<button id="login_button" class="button login__submit">
						<span class="button__text">Login</span> <i
